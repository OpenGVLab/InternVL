...
OUTPUT_DIR='work_dirs/internvl_chat_v2_5/InternVL2_5-8B-mmpr-plus-try5'
...
srun -p ${PARTITION} \
  ...
  --meta_path "/mnt/petrelfs/wangweiyun/workspace_wwy/open_source/InternVL/internvl_chat/shell/data/dev_mpo/meta_oc_data_241203_with_wh_v5.json" \
