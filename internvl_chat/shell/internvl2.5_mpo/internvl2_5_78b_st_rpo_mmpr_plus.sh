...
srun -p ${PARTITION} \
  ...
  --model_name_or_path "/mnt/petrelfs/wangweiyun/workspace_wwy/sync/oc_dpo_model_data_241203/sft_model" \
  --conv_style "internlm2-chat-v3" \
  --output_dir ${OUTPUT_DIR} \
  --meta_path "/mnt/petrelfs/wangweiyun/workspace_wwy/open_source/MMPR-Private-241208/meta.json" \
